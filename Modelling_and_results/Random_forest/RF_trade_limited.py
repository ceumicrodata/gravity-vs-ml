...
for chunk in chunks:
    ...
    X = X[['iso_o', 'iso_d','Period','contig', 'comlang_off','comcol', 'dist', 'Value', 'gdp_o', 'gdp_d']]
    X_predic = X_predic[['iso_o', 'iso_d','Period','contig', 'comlang_off','comcol', 'dist', 'Value', 'gdp_o', 'gdp_d']]
...
filename = f"RF_trade_limited_{timestamp}.csv"
