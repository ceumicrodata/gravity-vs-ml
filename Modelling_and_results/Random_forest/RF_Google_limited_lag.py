...
for chunk in chunks:
    ...
    X = X[['origin', 'destination', 'Timeline', 'population_2019', 'retail_and_recreation_percent_change_from_baseline', 'grocery_and_pharmacy_percent_change_from_baseline', 'parks_percent_change_from_baseline', 'transit_stations_percent_change_from_baseline', 'workplaces_percent_change_from_baseline', 'residential_percent_change_from_baseline', 'Value', 'lag1_Value', 'lag2_Value', 'lag3_Value', 'lag4_Value', 'lag5_Value', 'lag6_Value', 'lag7_Value', 'lag8_Value', 'lag9_Value', 'lag10_Value']]
...
filename = f"RF_Google_limited_lags_{timestamp}.csv"
