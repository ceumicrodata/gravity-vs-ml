...
node_id='iso_numeric'
node_timestamp='year'
node_features=['gdp'] #, 'total_population', 'urban_population(%_of_total)', 'area', 'dis_int', 'landlocked', 'citynum'
...
flows_features=['contig', 'comlang_off', 'comcol', 'dist',] #'comlang_ethno', 'colony', 'comcol', 'curcol', 'col45', 'smctry', 'dist', 'distcap', 'distw', 'distwces', 'Value_reverse', 'all_to_d', 'all_to_o', 'o_to_all', 'd_to_all'

# Add lag parameters
lag_periods = 1
time_dependent_edge_columns = ['Value'] #'Value', 'Value_reverse', 'all_to_d', 'all_to_o', 'o_to_all', 'd_to_all'
...
# Log columns
columns_to_scale = ['gdp', 'total_population', 'urban_population(%_of_total)', 'area', 'dis_int',
                'dist', 'distcap', 'distw', 'distwces', 'Value_reverse', 'all_to_d', 'all_to_o', 'o_to_all', 'd_to_all'] #Period, Value,
