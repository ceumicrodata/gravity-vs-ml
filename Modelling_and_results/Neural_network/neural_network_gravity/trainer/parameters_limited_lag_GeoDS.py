...
node_timestamp=''
node_features=['population_2019', 'population_density_2019', 'Total_area', 'residential_land_use_area', 'commercial_land_use_area', 'industrial_land_use_area', 'retail_land_use_area', 'natural_land_use_area', 'residential_roads_length', 'other_roads_length', 'main_roads_length', 'point_transport', 'building_transport', 'point_food', 'building_food', 'point_health', 'building_health', 'point_education', 'building_education', 'point_retail', 'building_retail']
...
flows_features=['neighbouring', 'distances', 'all_pop_flows_to_d', 'o_pop_flows_to_all', 'visitor_flows', 'visitor_flows_reverse', 'pop_flows_reverse', 'all_visitor_flows_to_d', 'all_visitor_flows_to_o', 'all_pop_flows_to_o', 'o_visitor_flows_to_all', 'd_visitor_flows_to_all', 'd_pop_flows_to_all']

# Add lag parameters
lag_periods = 3
time_dependent_edge_columns = ['pop_flows'] #'pop_flows', 'visitor_flows', 'visitor_flows_reverse', 'pop_flows_reverse', 'all_visitor_flows_to_d', 'all_pop_flows_to_d', 'all_visitor_flows_to_o', 'all_pop_flows_to_o', 'o_visitor_flows_to_all', 'o_pop_flows_to_all', 'd_visitor_flows_to_all', 'd_pop_flows_to_all'
...
# Log columns
columns_to_scale = ['distances', 'visitor_flows', 'visitor_flows_reverse', 'all_visitor_flows_to_d', 'all_visitor_flows_to_o', 'o_visitor_flows_to_all', 'd_visitor_flows_to_all',
